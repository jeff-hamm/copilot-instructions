...
description: 'Verify initial setup changes before commit: check drift, confirm required section markers, ensure Insiders paths exist, and print git status and diff stats.'
...
- Required embedded section markers exist.
- Stable and Insiders path references are present.
